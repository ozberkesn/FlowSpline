...
Project knowledge base lives in `wiki/`.
See [`wiki/CLAUDE.md`](wiki/CLAUDE.md) for wiki conventions.

Before starting any task, read:
- [`wiki/index.md`](wiki/index.md)
- [`wiki/open-questions.md`](wiki/open-questions.md)

After significant architectural changes, update the relevant wiki pages and append to
[`wiki/log.md`](wiki/log.md).

## Docs

The `wiki/raw/articles/` directory contains authoritative design documents
(immutable raw sources — never modify these directly):
